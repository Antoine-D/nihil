...
<div class="container-fluid font" style="border: 1px solid black;">
    <div class="row">
        ...
        <br>
            ...
            <div class="col-xs-12">
                <?php
                    $query = $bdd->prepare('SELECT * FROM message WHERE sender = :id ORDER BY id DESC');
                    ...
                    while($result = $query->fetch()) {
                        ...
                        echo "  <div class='row'>
                                    <div class='row'>
                                        ...
                                        <div class='col-xs-1'>Vu : ".$result['seen']."</div>
                                    </div>
                                    <div class='row'>
                                    ...
                                    <div class='row'>
                                        <div class='col-lg-12'>
                                            <a href='new_message.php?a=".$result2['Pseudo']."&b=".$result['object']."'>Envoyer un nouveau message</a>
