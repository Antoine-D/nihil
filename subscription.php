     ...
     <div class='container'>
      ...
      <div class="col-lg-6">
          <form method='POST' action='register.php'>
            ...
            <div class='form-group'>
              <label for='texte'>Mot de passe : ( 5 cacractères minimum )</label>
            ...
            foreach($_SESSION['error_subscription'] as $error) {
              if($error == 14) {
                ...
                echo "<div class='text-center'>
                    <div class='g-recaptcha' data-sitekey='6Lc83x0TAAAAAPwNza21SUpT-reTvyp7nPUBW-pg' data-theme ='dark'></div>
                </div>";
...
?>      
  ...
  <div class="col-lg-3"></div>  
    <form class="col-lg-6" method="POST" action="register.php">
        ...
        <div class="form-group">
          <label for="texte">Mot de passe : ( 5 caractères minimum )</label>
        ...
        <div class="form-group">
          ...
          <select name="Faction" id="select" class="form-control">
          	<?php
              foreach ($list_of_faction as $Faction) {
                if(isset($_POST['Faction']) && $_POST['Faction']==$Faction) {
                  echo "<option selected='selected'>".$Faction."</option>";
                } else {
          ...
          <a href="cgu.php" target="_blank">Lire les CGU</a>
       	</div>
       	<?php
