                                        ...
                                        <div class="button-guild">
                                                <?php
                                                    if ( isInGuild () ){
                                                        ...
                                                        if ( factionCorresp($data['Faction'], $_SESSION['Faction_ID']) ){
                                                            echo "
                                                            <div class='col-sm-5''></div>
                                                            <div class='col-sm-2'>
                                                                    <a class='btn btn-exit btn-warning' href='joinGuilde.php?Guild_ID=".$data['Guild_ID']."'>Rejoindre !</a>
                                                                  </div>
                                                            <div class='col-sm-5''></div>"; 
                                                        }
                                                else {
                                                    echo "
                                                    <div class='col-sm-4''></div>
                                                    <div class='alert alert-warning text-center col-sm-4'>
                                                    Vous ne pouvez pas rejoindre cette guilde<br>car elle se trouve dans la faction adverse !
                                                    </div>
                                                    <div class='col-sm-4'></div>";
                                                }
                                                ?>
